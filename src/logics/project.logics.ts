...
import { IProject, ITechnologyProject, TProjectRequest } from "../interfaces/project.interface";
...
const listProjectById = async (
  ...
  const queryResult: QueryResult<ITechnologyProject> = await client.query(queryConfig);
